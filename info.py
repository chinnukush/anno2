...
PICS = (environ.get('PICS', 'https://i.ibb.co/GfqTZfK8/image.jpg')).split() 
...
FSUB_IMG = (environ.get('FSUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')).split() 

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7253187871 8075224687').split()]  #Admin Id
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anikush8310:a0dTYntMqgRNf39e@cluster0.szgiyw7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #MongoDB Url
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1001999917591')) 
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1001999917591'))
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/TG_Bots_Support/216")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/TG_Bots_Support/216")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/TG_Bots_Support/216")
...
MSG_ALRT = environ.get('MSG_ALRT', 'Support us ♥️')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TG_SUPPORT_GROUP') #Support Chat Link
